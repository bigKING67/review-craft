...
and records skipped or invalid inputs explicitly. It also refreshes selectively reviewed
upstream references without changing schemas, dependencies, or supported workflows.
